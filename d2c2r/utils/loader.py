...
class DataLoader(object):
    ...
    def __init__(self, filename, batch_size, opt, evaluation):
        ...
        # ************* source data *****************
        source_train_data = "../dataset/" + filename + "/train.csv"
        source_valid_data = "../dataset/" + filename + "/valid.csv"
        source_test_data = "../dataset/" + filename + "/test.csv"
        ...
        target_valid_data = "../dataset/" + filename + "/valid.csv"
        target_test_data = "../dataset/" + filename + "/test.csv"
